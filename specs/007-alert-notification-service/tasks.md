...
- [x] 1.0 Complete schema modifications for region-specific subscriptions
  - [x] 1.1 Write 4-6 focused tests for schema modifications
...
- [x] 2.0 Complete status transition detection system
  - [x] 2.1 Write 4-6 focused tests for transition detection
  ...
  - [x] 2.2 Create internal function to compare previous vs new status
  ...
  - [x] 2.3 Integrate with status polling service mutation
  ...
  - [x] 2.4 Trigger alert processing pipeline on valid transitions
  ...
  - [x] 2.5 Ensure transition detection tests pass
...
- [x] 3.0 Complete alert processing and email sending system
  - [x] 3.1 Write 6-8 focused tests for alert processing and email sending
  ...
  - [x] 3.4 Configure Resend API integration
  ...
  - [x] 3.5 Create email template and content builder
  ...
  - [x] 3.6 Implement email sending internal action
    - Accept subscription details and email content
    - Call Resend API to send email
    - Return success/failure status
  - [x] 3.7 Implement exponential backoff retry logic
  ...
  - [x] 3.8 Update lastAlertSentAt after send initiated
  ...
  - [x] 3.9 Implement error handling and logging
  ...
  - [x] 3.10 Ensure alert processing tests pass
...
- [x] 4.0 Complete unsubscribe handling system
  - [x] 4.1 Write 4-6 focused tests for unsubscribe flow
  ...
  - [x] 4.2 Implement secure token generation
  ...
  - [x] 4.3 Create HTTP endpoint for unsubscribe
    - Route: /api/unsubscribe
    - Accept token as query parameter
    - Validate token against alertSubscriptions table
  - [x] 4.4 Implement token validation and subscription deactivation
  ...
  - [x] 4.5 Create confirmation page response
  ...
  - [x] 4.6 Ensure unsubscribe flow tests pass
...
- [x] 5.0 Complete notification preferences UI
  - [x] 5.1 Write 4-6 focused tests for notification preferences UI
  ...
  - [x] 5.2 Create notification preferences section component
  ...
  - [x] 5.3 Implement subscription list display
  ...
  - [x] 5.4 Implement enable/disable toggle for subscriptions
  ...
  - [x] 5.5 Create "Add subscription" flow
  ...
  - [x] 5.6 Implement confirmation feedback
  ...
  - [x] 5.7 Apply styling consistent with settings page
    - Follow existing design system
    - Match spacing, typography, and colors from settings page
    - Ensure responsive layout
  - [x] 5.8 Ensure notification preferences UI tests pass
...
All 6 task groups have been completed. The Alert Notification Service now includes:

### Files Created/Modified:
- `convex/schema.ts` - Updated alertSubscriptions table with region, lastAlertSentAt, unsubscribeToken fields and indexes
- `convex/lib/transitionDetection.ts` - Status transition detection utility
- `convex/alertNotifications.ts` - Alert processing pipeline, email sending, subscription management
- `convex/statusMutations.ts` - Updated to integrate transition detection
- `convex/http.ts` - HTTP router with unsubscribe endpoint
- `convex/_generated/api.ts` - Updated with alertNotifications internal API types
- `convex/_generated/server.ts` - Added httpAction export
- `src/components/NotificationPreferences/` - New UI component with CSS styling
- `src/pages/Settings/Settings.tsx` - Integrated notification preferences section

### Test Files:
- `convex/__tests__/alertSubscriptions.schema.test.ts` - 6 tests
- `convex/__tests__/alertNotification.transition.test.ts` - 6 tests
- `convex/__tests__/alertNotification.processing.test.ts` - 15 tests
- `convex/__tests__/alertNotification.unsubscribe.test.ts` - 8 tests
- `convex/__tests__/alertNotification.integration.test.ts` - 10 tests
- `src/components/NotificationPreferences/NotificationPreferences.test.tsx` - 5 tests

**Total feature-specific tests: 50 tests passing**
