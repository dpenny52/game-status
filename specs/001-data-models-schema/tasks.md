...
- [ ] 1.0 Complete schema foundation and enum types
  - [ ] 1.1 Write 3-5 focused tests for enum validators
  ...
  - [ ] 1.6 Ensure enum validator tests pass
...
- [ ] 2.0 Complete games table definition
  - [ ] 2.1 Write 2-4 focused tests for games table schema
...
- [ ] 3.0 Complete users table definition
  - [ ] 3.1 Write 2-4 focused tests for users table schema
...
- [ ] 4.0 Complete server status tables
  - [ ] 4.1 Write 4-6 focused tests for status tables
  ...
  - [ ] 4.2 Define serverStatusRecords table schema
  ...
  - [ ] 4.3 Add serverStatusRecords indexes
  ...
  - [ ] 4.4 Define statusHistory table schema
    - `gameId`: v.id("games") - foreign key to games table
  ...
  - [ ] 4.5 Add statusHistory indexes
    - Index on `gameId` for game-specific history queries
    - Index on `timestamp` for time-range queries
  - [ ] 4.6 Ensure status tables tests pass
...
- [ ] 5.0 Complete user preference tables
  - [ ] 5.1 Write 3-5 focused tests for preference tables
  ...
  - [ ] 5.2 Define favorites table schema (junction table)
...
- [ ] 6.0 Complete schema integration and validation
  ...
  - [ ] 6.2 Assemble complete schema export
  ...
  - [ ] 6.5 Run all schema-related tests
