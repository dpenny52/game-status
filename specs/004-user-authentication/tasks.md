...
- [x] 1.0 Complete Convex Auth configuration
  - [x] 1.1 Write 2-4 focused tests for auth configuration
  ...
  - [x] 1.2 Install and configure Convex Auth package
    - Add @convex-dev/auth dependency
    - Initialize auth configuration in convex/auth.config.ts
  - [x] 1.3 Configure session management settings
  ...
  - [x] 1.5 Ensure auth configuration tests pass
...
- [x] 2.0 Complete email/password authentication backend
  - [x] 2.1 Write 4-6 focused tests for email/password auth
  ...
  - [x] 2.6 Ensure email/password auth tests pass
...
- [x] 3.0 Complete OAuth authentication backend
  - [x] 3.1 Write 4-6 focused tests for OAuth authentication
  ...
  - [x] 3.2 Configure Discord OAuth provider
  ...
  - [x] 3.5 Implement OAuth error handling
    - Catch and log OAuth failures
    - Return user-friendly error messages
    - Handle denied permissions gracefully
  - [x] 3.6 Ensure OAuth tests pass
...
- [x] 4.0 Complete Magic Link and Password Reset backend
  - [x] 4.1 Write 4-6 focused tests for Magic Link and Password Reset
  ...
  - [x] 4.2 Implement Magic Link token generation
...
- [x] 5.0 Complete authentication modal components
  - [x] 5.1 Write 4-6 focused tests for modal components
  ...
  - [x] 5.4 Create Signup modal component
  ...
  - [x] 5.5 Implement password strength indicator component
    - Visual strength meter (weak/medium/strong)
    - Real-time updates as user types
    - Color coding (red/yellow/green)
    - Requirements checklist display
  - [x] 5.6 Implement form validation utilities
    - Email format validation
    - Password requirements validation
    - Display name length validation
    - Confirm password match validation
  - [x] 5.7 Style modal components
  ...
  - [x] 5.8 Ensure modal component tests pass
...
- [x] 6.0 Complete authentication pages and profile
  - [x] 6.1 Write 4-6 focused tests for auth pages
  ...
  - [x] 6.2 Create Password Reset page
  ...
  - [x] 6.3 Create Profile/Settings page
    - Route at /settings
...
- [x] 7.0 Review existing tests and fill critical gaps only
  ...
  - [x] 7.4 Run authentication feature tests only
