...
- [ ] 1.0 Complete core scheduler and retry infrastructure
  - [ ] 1.1 Write 4-6 focused tests for scheduler and retry logic
  ...
  - [ ] 1.4 Create publisher dispatch coordinator
...
- [ ] 2.0 Complete Blizzard API integration
  - [ ] 2.1 Write 4-6 focused tests for Blizzard integration
  ...
  - [ ] 2.4 Implement WoW HTML scraping fallback
  ...
  - [ ] 2.5 Create mutation to store Blizzard status results
...
- [ ] 3.0 Complete Riot Games API integration
  - [ ] 3.1 Write 4-6 focused tests for Riot integration
  ...
  - [ ] 3.4 Create mutation to store Riot status results
    - Write to serverStatusRecords table
    - Store region-specific status records
    - Update timestamps appropriately
  - [ ] 3.5 Ensure Riot integration tests pass
...
- [ ] 4.0 Complete Steam/Valve API integration
  - [ ] 4.1 Write 3-4 focused tests for Steam integration
  ...
  - [ ] 4.2 Create Steam status fetcher internal action
...
- [ ] 5.0 Complete Epic Games integration
  - [ ] 5.1 Write 3-4 focused tests for Epic integration
  ...
  - [ ] 5.4 Create mutation to store Epic status results
    - Write to serverStatusRecords table
    - Store component-level details if schema supports
    - Update timestamps appropriately
  - [ ] 5.5 Ensure Epic integration tests pass
...
- [ ] 6.0 Complete Mojang/Microsoft integration
  - [ ] 6.1 Write 3-4 focused tests for Mojang integration
  ...
  - [ ] 6.2 Create Mojang status fetcher internal action
    - Query Mojang Status API (public endpoint)
    - Check Xbox Live status for auth dependencies
    - No API key required
    - 30-second timeout for HTTP requests
  - [ ] 6.3 Implement service component parsing
  ...
  - [ ] 6.4 Create mutation to store Mojang status results
    - Write to serverStatusRecords table
    - Store component-level details if schema supports
    - Update timestamps appropriately
  - [ ] 6.5 Ensure Mojang integration tests pass
...
- [ ] 7.0 Complete Square Enix integration
  ...
  - [ ] 7.4 Implement maintenance notice parsing
  ...
  - [ ] 7.5 Create mutation to store Square Enix status results
    - Write to serverStatusRecords table
    - Store region/data center specific status
    - Update timestamps appropriately
  - [ ] 7.6 Ensure Square Enix integration tests pass
