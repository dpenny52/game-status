...
- [x] 1.0 Complete Convex backend for favorites functionality
  - [x] 1.1 Write 2-6 focused tests for Convex functions
  ...
  - [x] 1.2 Create toggleFavorite mutation
  ...
  - [x] 1.3 Create getUserFavorites query
    - File: `convex/favorites.ts`
    - Use `ctx.auth.getUserIdentity()` to get current user
  ...
  - [x] 1.4 Modify dashboard games query for favorites-first sorting
  ...
  - [x] 1.5 Ensure Convex function tests pass
...
- [x] 2.0 Complete FavoriteToggle component
  - [x] 2.1 Write 2-6 focused tests for FavoriteToggle component
  ...
  - [x] 2.2 Create FavoriteToggle component structure
  ...
  - [x] 2.3 Implement toggle functionality with optimistic updates
  ...
  - [x] 2.5 Implement event propagation handling
  ...
  - [x] 2.6 Ensure FavoriteToggle tests pass
...
- [x] 3.0 Complete visual styling and GameCard integration
  - [x] 3.1 Write 2-6 focused tests for styling and integration
  ...
  - [x] 3.2 Style FavoriteToggle component states
  ...
  - [x] 3.3 Extend GameCard component for favorites
  ...
  - [x] 3.4 Apply favorited card border styling
  ...
  - [x] 3.5 Implement conditional rendering for anonymous users
  ...
  - [x] 3.6 Ensure styling and integration tests pass
...
- [x] 4.0 Complete dashboard integration and verify all tests
  - [x] 4.1 Integrate favorites into dashboard page
  ...
  - [x] 4.4 Analyze test coverage gaps for favorites feature only
  ...
  - [x] 4.5 Write up to 8 additional strategic tests if needed
