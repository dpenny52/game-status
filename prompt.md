...
implement the single highest priority feature from specs - only work on a SINGLE feature

prefer to use available skills by starting sub-agents over implementing directly

if all tasks in the specs are complete, update a TODO.md file with one critical feature to build in the future
